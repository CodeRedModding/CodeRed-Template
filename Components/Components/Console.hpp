...
namespace CodeRed
{
	...
	private:
		...
		HANDLE m_outputHandle; // Related to opening the console window.
		FILE* m_outputFile; // Related to opening the console window.
	...
	public: // Writing and logging functions.
